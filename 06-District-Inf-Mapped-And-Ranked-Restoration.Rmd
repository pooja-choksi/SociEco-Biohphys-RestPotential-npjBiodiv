...
#alternate file
district_mpi_climate_summary = read.csv("District-MPi-Ranked-V2.csv")
...
writeOGR(obj = districts_merged, layer = "districts", dsn= "District-MPI-Merged-593districts.shp", driver = "ESRI Shapefile")

#original dataset with MPi and climate
