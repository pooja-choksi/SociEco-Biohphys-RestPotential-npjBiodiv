...
district_mpi_climate_summary= district_mpi_climate_summary%>%dplyr::mutate(Mean_Rank = rowMeans(.[, 18:20]))

#rearrange the districts in descending order of MPI
district_mpi_climate_summary  <- district_mpi_climate_summary [order(district_mpi_climate_summary$Mean_Rank, decreasing=FALSE),]
