...
district_mpi_climate_summary = district_mpi_climate_summary%>%dplyr::mutate(State = recode(State, "Andaman Nicobar UT" = "Andaman and Nicobar", "Daman Diu" = "Daman and Diu", "NCT_Delhi" = "NCT of Delhi", "Jammu And Kashmir" = "Jammu and Kashmir", "Dadra Nagarhaveli UT" = "Dadra and Nagar Haveli", "Tamil_Nadu" = "Tamil Nadu", "West_Bengal" = "West Bengal"))
...
trial_changed = district_mpi_climate_summary%>%dplyr::mutate(District_Name = recode(District_Name, "Kanker" = "Uttar Bastar Kanker",
"Sonepur" ="Subarnapur",
"Boudh" ="Bauda",
"Shopian" ="Shupiyan",
...
"West Singhbhum" = "Purbi Singhbhum",                                "Saraikela Kharsawan" = "Saraikela-kharsawan", 
"Dhar " = "Dhar", 
...
"Medinipur West" = "Pashchim Medinipur",
...
#check again
#Check for district names that don't match
district_names_missing =  setdiff(trial_changed$District_Name,
