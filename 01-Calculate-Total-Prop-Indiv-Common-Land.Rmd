---
title: "01-Calculate-Individual-Common-Forest-Land-Tenure"
author: "Pooja Choksi"
date: "`r Sys.Date()`"
...
Land-use data (with a total of ten categories of land uses included) 
...
#Loop through all state folders to find the land use 
#record for all districts stitched together in previous code
dat.summary.original = sapply(list.files(path="C:\\Users\\pooja\\Documents\\GitHub\\Land-Tenure-Restoration-Potential\\Land-Tenure-Restoration-Potential\\Census2011-landUse-CSVFiles\\Sheets_For_Analysis",
                                         recursive=T, #looping through each subfolder for state
                                         pattern="_Census2011_LandUse.csv",full.names=T), function(file) {
                                           df = read.csv(file, stringsAsFactors=FALSE, colClasses=c(Village_name= "character",
...
CALCULATION OF TOTAL AREA IN VILLAGE 
...
Details on this section in  https://docs.google.com/document/d/1QS1E9VQGWX0HaQfXfcDWlG7fv6kZJn7oYxvjMaaQnF4/edit?usp=sharing
...
# Filter out the no_match from (c)
...
#generate csv
setwd("D:\\Global_Restoration_potential\\Census2011-landUse-CSVFiles\\Sheets_For_Analysis")
