...
district_total_plot = districts_info%>%dplyr::group_by(People_Percentile_Upper)%>%
...
district_total_plot_long = reshape2::melt(district_total_plot, id.vars = "People_Percentile_Upper")

#plot
district_stacked_barplot_totals = 
district_total_plot_long%>%
  ggplot(aes(x = factor(People_Percentile_Upper), y = value, fill = variable))+
...
district_prop_plot = district_prop_plot%>%mutate(Prop_Indiv = (total_indiv/(total_indiv+total_common+total_forest+total_unaccounted))*100,
...
district_prop_plot_long = reshape2::melt(district_prop_plot_long, id.vars = "People_Percentile_Upper")
