...
high_districts = district_mpi_climate_summary%>%filter(MPI_cat == "High" &
                                                         vulnerability_cat == "High" & Total_Pop_Cat == "High")

verylow_districts = district_mpi_climate_summary%>%filter(MPI_cat == "Very low" &
                                                         vulnerability_cat == "Very low" & Total_Pop_Cat == "Very low")
