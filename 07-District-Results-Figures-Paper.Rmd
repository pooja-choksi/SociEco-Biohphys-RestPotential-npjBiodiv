...
top_districts = district_mpi_climate_summary%>%filter(People_centric_Mean>0.5425)

high_districts = district_mpi_climate_summary%>%filter(People_centric_Mean>0.5425)

middle_districts = district_mpi_climate_summary%>%filter(People_centric_Mean >0.4745 & People_centric_Mean<0.5425)
