...
districts <- districts[!is.na(districts$MPI_rnk),]
#N = 565 after removing the districts without CV (one districts has three parts). the total is still 563 districts
