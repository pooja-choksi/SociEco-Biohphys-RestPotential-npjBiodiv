...
districts= districts[!is.na(districts$Lvng_st),]

districts_final = sp::merge(districts, potential_extracted[c("Strassburg_India_Clipped", #"Strassburg_bioclim_Scaled", "scen_cb.bd_gradient",
