...
potential_extracted = merge(strassburg_blioclim_extracted_df, strassburg_extracted_df[c("Strassburg_India_Clipped", "NAME_1", "NAME_2")], by.x = c("NAME_2", "NAME_1"), by.y =c("NAME_2", "NAME_1"))
...
potential_extracted  <- potential_extracted [order(potential_extracted$scen_cb.bd_gradient, decreasing=FALSE),]

potential_extracted$Strassburg_bioclim_Scaled = range01(potential_extracted$scen_cb.bd_gradient)
...
districts_final = sp::merge(districts, potential_extracted[c("Strassburg_India_Clipped", "Strassburg_bioclim_Scaled", "scen_cb.bd_gradient", "Strassburg_Scaled_final", "NAME_1", "NAME_2")], by.x = c("NAME_1","NAME_2"), by.y= c("NAME_1", "NAME_2"), duplicateGeoms = T)

writeOGR(districts_final, layer = "districts_final", dsn= "District-MPI-Climate-Pop-Merged-Biophys.shp", driver = "ESRI Shapefile")

#alternate file with only MPI and land use
...
write.csv(districts_df_final, "District-MPI-Biophys-Ranked.csv")
